                ...
                <div className="price-features-wrapper mt-3">
                    <div className="d-flex flex-wrap gap-3 w-100">
                        {[
                            ...
                            >
                                <div className="square--35 text-muted-2 fs-md circle gray-simple d-flex align-items-center justify-content-center">
                                    <i
                                        className={`fa-solid ${feature.icon} fa-lg feature-icon`}
                                    ></i>
                                </div>
                                <span className="text-muted-2 fw-medium feature-text text-lowercase">
                                    {feature.label}
                                </span>
                            </div>
                        ))}
