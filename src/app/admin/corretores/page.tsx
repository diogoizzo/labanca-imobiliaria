                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 col-md-12">
                            <h2 className="ipt-title text-light">
                                Nossa Equipe de Especialistas em Barra do Piraí
                            </h2>
                            <span className="ipn-subtitle">
                                Os melhores corretores da Labanca prontos para
                                te atender!
                            </span>
                        </div>
                    </div>
                                            ...
                                            <div className="form-group">
                                                <div className="position-relative">
                                                    <input
                                                        ...
                                                        placeholder="Buscar imóveis em Barra do Piraí"
                                                    />
                                                ...
                                                <ul className="p-0">
                                                    ...
                                                    <li>
                                                        <div className="fr-can-rating">
                                                            <i
                                                                className="fas fa-star fs-xs text-warning"
                                                                style={{
                                                                    margin: "0 2px",
                                                                }}
                                                            ></i>
                                                            ...
                                                            ></i>
                                                            <i
                                                                className="fas fa-star fs-xs text-muted"
                                                                style={{
                                                                    margin: "0 2px",
                                                                }}
                                                            ></i>
