...
export default function HowItsWorkSale() {
    return (
                ...
                <div className="col-xl-6 col-lg-7 col-md-10 text-center">
                    <div className="sec-heading center">
                        <h2 className="title-text">
                            Conheça o procedimento de Compra e Venda.
                        </h2>
                        <p className="normal-text">
                            Descubra como a Labanca Imobiliária simplifica o
                            processo de compra e venda de imóveis em Barra do
                            Piraí. Nosso método é transparente, eficiente e
                            focado em você.
                        </p>
                    </div>
                </div>
